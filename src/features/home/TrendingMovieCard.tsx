...
function TrendingMovieCard({ movie }) {
  ...
  return (
    <div
      className="group relative z-10 h-[8.75rem] w-full max-w-[15rem] rounded-lg bg-cover bg-no-repeat object-contain md:h-[14.375rem] md:w-full md:max-w-[29.375rem] md:cursor-pointer"
      style={{
